    ...
    <>
      ...
      <div className="max-w-6xl mx-auto p-4 grid grid-cols-3 gap-6">
        ...
        {selectedItems.length > 0 && (
          <div className="fixed bottom-4 right-4 z-50 bg-white border shadow-lg rounded-xl p-6 w-80 space-y-3">
            ...
            <button
              ...
              className="bg-green-500 hover:bg-green-600 text-white font-bold w-full py-2 rounded-lg"
            >
              Đặt hàng
            </button>
          </div>
